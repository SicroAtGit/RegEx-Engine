...
DeclareModule RegEx
  ...
  ; `RegExEngineStruc` structure. The optional `regExEngineModes` parameter
  ; allows defining which RegExEngine modes should be activated. If an error
...
Module RegEx
  ...
  Procedure UseDfaFromMemory(*dfaMemory)
    ...
    *regExEngine = AllocateStructure(RegExEngineStruc)
    If *regExEngine
      CopyMemory(*dfaMemory, @*regExEngine\regExEngineModes, SizeOf(*regExEngine\regExEngineModes))
      *dfaMemory + SizeOf(*regExEngine\regExEngineModes)
  ...
  Procedure ExportDfa(*regExEngine.RegExEngineStruc, filePath$)
    ...
    If Not WriteData(file, @*regExEngine\regExEngineModes, SizeOf(*regExEngine\regExEngineModes))
      CloseFile(file)
      ProcedureReturn #False
    EndIf
